...
function createMenuItem(theName, thePrice, theCategory){
return {name: theName, price: thePrice, category: theCategory}
}
...
reviews.push({name: "Michelle", rating: 1, feedback: "It's my first time here. Not much to it."})
